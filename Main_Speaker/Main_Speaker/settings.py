"""
Django settings for Main_Speaker project.
...
SECRET_KEY = 'django-insecure-naalrj@tnu%fyh$ekj&hx^@u_boqpmh6yftqj@+q14fnc7z4-t'
...
ROOT_URLCONF = 'Main_Speaker.urls'
...
WSGI_APPLICATION = 'Main_Speaker.wsgi.application'
